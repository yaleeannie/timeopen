alter table public.organizations
  add column if not exists booking_contact text null;

comment on column public.organizations.booking_contact is
  'Contact method shown to customers after booking for booking-related inquiries.';
