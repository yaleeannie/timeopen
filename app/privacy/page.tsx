...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "보유 기간: 예약 관리 및 분쟁 대응을 위해 필요한 기간 동안 보관하며, 보유 목적이 달성되면 관련 법령 및 내부 기준에 따라 파기합니다.",
  ...
  },
  {
    ...
    body: [
      "TimeOpen은 개인정보처리방침을 변경하는 경우 서비스 화면, 이메일 또는 기타 적절한 방법으로 안내할 수 있습니다. 개인정보 처리에 중요한 변경이 있는 경우 합리적인 기간 전에 고지합니다.",
    ],
  },
  {
    title: "12. 문의",
