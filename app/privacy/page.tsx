...
const sections = [
  ...
  {
    title: "5. 비활성 또는 미완료 계정",
    body: [
      "가입 후 장기간 서비스 이용 또는 예약 링크 설정이 없는 계정은 사전 안내 후 비활성 처리하거나 관련 법령 및 내부 기준에 따라 삭제 또는 익명화할 수 있습니다.",
      "예를 들어 이메일 인증이 완료되지 않은 계정, 온보딩 또는 샵 설정이 완료되지 않은 계정, 장기간 예약 링크 사용 이력이 없는 계정은 검토 대상이 될 수 있습니다.",
      "다만 실제 예약 내역이 있거나 분쟁 대응, 법령상 보관 필요성이 있는 정보는 필요한 기간 동안 보관될 수 있습니다.",
    ],
  },
  {
