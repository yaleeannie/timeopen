      ...
      <div className="glass-shell mx-auto w-full min-w-0 max-w-lg overflow-hidden rounded-[28px] sm:rounded-[36px]">
        <div className="px-4 pb-7 pt-5 sm:px-6 sm:pb-9 sm:pt-7">
          <header className="mb-6">
            ...
            <h1 className="text-3xl font-black tracking-[-0.04em]">메뉴판 관리</h1>
            <p className="mt-1 text-sm leading-5 text-gray-500">고객이 인스타 예약 링크에서 고를 메뉴와 가격을 관리하세요.</p>
          </header>
          ...
          <nav className="brand-nav mt-7 grid grid-cols-4 gap-1 rounded-2xl p-2">
            ...
            <a href="/settings/services" className="brand-chip flex min-h-11 items-center justify-center rounded-xl text-sm font-black">메뉴판</a>
